"""Run the eight-family Mistral 24B base capability screen before splitting."""
...
app = modal.App("screen-mistral24b-complete-capability")
...
def screen() -> dict:
    ...
    return {
        "status": "pre_split_complete_eight_family_base_screen_complete",
        "scope": (
...
def main() -> None:
    ...
    output = Path("data/behavior_audit/mistral24b_complete_base_screen.json")
