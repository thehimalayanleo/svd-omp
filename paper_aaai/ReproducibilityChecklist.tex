...
\item Number of algorithm runs / seeds: currently \textbf{one seed} for the trained baselines. Ablations under multiple seeds would strengthen error-bar claims; planned for the camera-ready version.
